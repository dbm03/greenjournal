...
const Tips = () => {
    ...
    >
        ...
        {vals.map((val) =>
          <Mini title={"Log #" + (String)(vals.indexOf(val)+1)} content={val}></Mini>
        )}
        </div>

        </CardBody>
        <div className="flex flex-col-reverse justify-center items-center">
        <Button style={min} color="success" className="text-md" size="sm" onPress={onOpen}><b>+</b></Button>
        </div>
        ...
        <ModalContent>
            {(onClose) => (
            <>
                <ModalHeader className="flex flex-col gap-1">Log Your Progress</ModalHeader>
                <ModalBody>
                <p> 
                    The best way to hold yourself accountable is by logging your progress regularly. Feel free to log what
                    changes you have made in your life to reduce your carbon footprint or make a commitment to make changes
                    in the future.
                </p>
