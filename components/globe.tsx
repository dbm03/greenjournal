...
export default function Globe({ ...props }) {
  ...
  useFrame(() => {
    ...
    if (globeGroupRef.current) {
      ...
      clouds.current.rotation.y += (ROTATION_SPEED - 0.4) * delta;
      planes.current.rotation.x -= ROTATION_SPEED * delta;
      planes.current.rotation.y -= (ROTATION_SPEED + 0.05) * delta;
    }
  });
  ...
  return (
    <>
      ...
      <group {...props} dispose={null}>
        <group
          ref={planes}
          position={[flights == 0 ? 4000 : 2.24, 5.7, 3.29]}
